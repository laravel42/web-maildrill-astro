  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // Replicates the email-builder MUI tooltip (theme.ts → MuiTooltip): a
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-[#2c2c2c] fill-[#2c2c2c]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
