...
describe("builder42 tour i18n — paridad de claves", () => {
  ...
  it("cada ancla del registro tiene un par steps.<id>.title/description en el catálogo en", () => {
    ...
    const stepIdByAnchor: Record<string, string> = {
      ...
      [BUILDER42_TOUR_ANCHORS.settingsTabs]: "settingsTabs",
      [BUILDER42_TOUR_ANCHORS.settingsLayers]: "settingsLayers",
      [BUILDER42_TOUR_ANCHORS.settingsPages]: "settingsPages",
      [BUILDER42_TOUR_ANCHORS.settingsLanguages]: "settingsLanguages",
