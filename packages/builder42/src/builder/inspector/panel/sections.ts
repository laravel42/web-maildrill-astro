...
export const PANEL_SECTIONS: SectionDescriptor[] = [
  {
    ...
    rows: [
      ...
      {
        id: "layout.gap",
        labelKey: "panel.rows.gap",
        control: "presetNumeric",
        fields: [["layout", "gap"]],
        tier: "common",
        presets: [
          { labelKey: "panel.gap.s", value: "8px" },
          { labelKey: "panel.gap.m", value: "16px" },
          { labelKey: "panel.gap.l", value: "24px" },
          { labelKey: "panel.gap.xl", value: "32px" },
        ],
      },
  ...
  },
  {
    ...
    rows: [
      ...
      {
        id: "size.height",
        labelKey: "panel.rows.height",
        control: "presetNumeric",
        fields: [["size", "height"]],
        tier: "common",
        presets: [
          { labelKey: "panel.height.s", value: "32px" },
          { labelKey: "panel.height.m", value: "48px" },
          { labelKey: "panel.height.l", value: "64px" },
          { labelKey: "panel.height.xl", value: "96px" },
        ],
      },
  ...
  },
  {
    ...
    rows: [
      ...
      { id: "typography.align", labelKey: "panel.rows.textAlign", control: "segmented", fields: [["typography", "textAlign"]], tier: "common" },
      {
        ...
        labelKey: "panel.rows.fontWeight",
        control: "presetNumeric",
        fields: [["typography", "fontWeight"]],
        tier: "common",
        presets: [
          { labelKey: "panel.fontWeight.s", value: "400" },
          { labelKey: "panel.fontWeight.m", value: "500" },
          { labelKey: "panel.fontWeight.l", value: "600" },
  ...
  },
  {
    ...
    rows: [
      { id: "appearance.background", labelKey: "panel.rows.background", control: "color", fields: [["appearance", "background"]], tier: "common" },
      {
        ...
        labelKey: "panel.rows.borderRadius",
        control: "presetNumeric",
        fields: [["appearance", "borderRadius"]],
        tier: "common",
        presets: [
          { labelKey: "panel.borderRadius.s", value: "4px" },
          { labelKey: "panel.borderRadius.m", value: "8px" },
          { labelKey: "panel.borderRadius.l", value: "16px" },
          { labelKey: "panel.borderRadius.xl", value: "24px" },
        ],
      },
