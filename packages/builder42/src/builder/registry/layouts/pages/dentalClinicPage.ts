...
export function buildDentalClinicPageFragment(): NodeFragment {
  const fragment: NodeFragment = {
    ...
    nodes: {
      ...
      "dental-topbar-phone": {
        ...
        type: "text",
        props: { content: "24h emergencies: +52 33 1122 3344" },
      ...
      "dental-navbar-brand": {
        ...
        type: "text",
        props: { content: "<strong>Sonrisa Plena Dental Clinic</strong>" },
        style: {
          base: {
      ...
      "dental-hero-badge": {
        ...
        type: "badge",
        props: { label: "We accept insurance" },
        style: defaultStyleFor("badge"),
      },
      "dental-hero-title": {
        id: "dental-hero-title",
        type: "text",
        props: { content: "<strong>Dental care close to home, for the whole family</strong>" },
        style: {
          base: {
            size: { maxWidth: "22ch" },
            typography: {
      ...
      "dental-hero-sub": {
        ...
        type: "text",
        props: {
          content: "A modern office, a warm team and clear treatment plans, with options to pay through your dental insurance.",
        },
        style: {
          base: {
            size: { maxWidth: "48ch" },
      ...
      "dental-hero-cta": {
        id: "dental-hero-cta",
        type: "button",
        props: { label: "Book my appointment", link: { kind: "anchor", nodeId: "dental-appointment" } },
        style: {
          base: {
      ...
      "dental-treatment-1-media": {
        ...
        props: {
          ...
          alt: "Dental hygienist performing a cleaning",
          objectFit: "cover",
          loading: "lazy",
        },
        style: {
      ...
      "dental-treatment-1-icon": {
        ...
        type: "icon",
        props: { name: "Sparkles", pressedName: "", title: "Dental cleaning" },
        style: defaultStyleFor("icon"),
      },
      "dental-treatment-1-title": {
        id: "dental-treatment-1-title",
        type: "text",
        props: { content: "<strong>Cleaning & prevention</strong>" },
        style: {
          base: {
      ...
      "dental-treatment-1-text": {
        ...
        type: "text",
        props: { content: "Check-ups and professional cleaning to keep your oral health on track." },
      ...
      "dental-treatment-2-icon": {
        ...
        type: "icon",
        props: { name: "Smile", pressedName: "", title: "Orthodontics" },
        style: defaultStyleFor("icon"),
      },
      "dental-treatment-2-title": {
        id: "dental-treatment-2-title",
        type: "text",
        props: { content: "<strong>Orthodontics</strong>" },
        style: {
          base: {
            typography: { fontSize: "1.25rem", lineHeight: "1.3", fontWeight: { token: "typography.weights.bold" } },
            appearance: { color: { token: "colors.text" } },
      ...
      "dental-treatment-2-text": {
        ...
        type: "text",
        props: { content: "Traditional braces and clear aligners, with a payment plan that fits you." },
        style: { base: { size: { maxWidth: "60ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      "dental-treatment-3": {
      ...
      "dental-treatment-3-media": {
        ...
        props: {
          ...
          alt: "Little girl smiling at the dental office",
          objectFit: "cover",
          loading: "lazy",
        },
        style: {
      ...
      "dental-treatment-3-icon": {
        ...
        type: "icon",
        props: { name: "Baby", pressedName: "", title: "Pediatric dentistry" },
        style: defaultStyleFor("icon"),
      },
      "dental-treatment-3-title": {
        id: "dental-treatment-3-title",
        type: "text",
        props: { content: "<strong>Pediatric dentistry</strong>" },
        style: {
          base: {
            typography: { fontSize: "1.25rem", lineHeight: "1.3", fontWeight: { token: "typography.weights.bold" } },
            appearance: { color: { token: "colors.text" } },
      ...
      "dental-treatment-3-text": {
        ...
        type: "text",
        props: { content: "Care designed for little ones, in a relaxed and friendly environment." },
        style: { base: { size: { maxWidth: "60ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      ...
      "dental-team-title": {
        ...
        type: "text",
        props: { content: "<strong>Meet our team</strong>" },
        style: {
          base: {
            typography: { fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: { token: "typography.weights.bold" }, lineHeight: "1.15" },
            appearance: { color: { token: "colors.text" } },
      ...
      "dental-team-member-1-avatar": {
        ...
        type: "avatar",
        props: { source: { kind: "url", url: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&q=80&auto=format&fit=crop" }, alt: "Portrait of Dr. Camila Reyes", initials: "CR" },
        style: defaultStyleFor("avatar"),
      },
      "dental-team-member-1-name": {
        id: "dental-team-member-1-name",
        type: "text",
        props: { content: "<strong>Dr. Camila Reyes</strong>" },
        style: { base: { appearance: { color: { token: "colors.text" } } } },
      },
      "dental-team-member-1-role": {
        id: "dental-team-member-1-role",
        type: "text",
        props: { content: "Clinical director & general dentistry" },
        style: { base: { appearance: { color: { token: "colors.muted" } } } },
      },
      ...
      "dental-team-member-2-avatar": {
        ...
        type: "avatar",
        props: { source: { kind: "url", url: "https://images.unsplash.com/photo-1622253694238-3b22139576c6?w=200&q=80&auto=format&fit=crop" }, alt: "Portrait of Dr. Andrés Molina", initials: "AM" },
        style: defaultStyleFor("avatar"),
      },
      ...
      "dental-team-member-3-avatar": {
        ...
        type: "avatar",
        props: { source: { kind: "url", url: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=200&q=80&auto=format&fit=crop" }, alt: "Portrait of Dr. Sofía Liévano", initials: "SL" },
        style: defaultStyleFor("avatar"),
      },
      "dental-team-member-3-name": {
        id: "dental-team-member-3-name",
        type: "text",
        props: { content: "<strong>Dr. Sofía Liévano</strong>" },
        style: { base: { appearance: { color: { token: "colors.text" } } } },
      },
      "dental-team-member-3-role": {
        id: "dental-team-member-3-role",
        type: "text",
        props: { content: "Pediatric dentistry" },
        style: { base: { appearance: { color: { token: "colors.muted" } } } },
      },
      ...
      "dental-faq-item-1": {
        ...
        type: "accordion-item",
        props: { label: "How much does a first assessment cost?", openByDefault: true },
      ...
      "dental-faq-item-1-body": {
        ...
        type: "text",
        props: { content: "The first assessment costs $450 MXN, and includes a general check-up and an X-ray if needed. The amount is deducted if you continue with treatment." },
        style: { base: { size: { maxWidth: "70ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      "dental-faq-item-2": {
        id: "dental-faq-item-2",
        type: "accordion-item",
        props: { label: "Do you work with insurance companies?", openByDefault: false },
        style: defaultStyleFor("accordion-item"),
      ...
      "dental-faq-item-2-body": {
        ...
        type: "text",
        props: { content: "Yes, we work with the country's main insurance providers. Bring your policy to your first visit and we'll check your coverage at no cost." },
        style: { base: { size: { maxWidth: "70ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      "dental-faq-item-3": {
        id: "dental-faq-item-3",
        type: "accordion-item",
        props: { label: "What should I expect on my first visit?", openByDefault: false },
        style: defaultStyleFor("accordion-item"),
      ...
      "dental-faq-item-3-body": {
        ...
        type: "text",
        props: { content: "A full check-up, a conversation about your needs, and a clear treatment plan with options and timelines before you decide." },
        style: { base: { size: { maxWidth: "70ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      "dental-faq-item-4": {
        id: "dental-faq-item-4",
        type: "accordion-item",
        props: { label: "Do you treat children?", openByDefault: false },
        style: defaultStyleFor("accordion-item"),
      ...
      "dental-faq-item-4-body": {
        ...
        type: "text",
        props: { content: "Yes, we have a pediatric dentistry area designed to make children feel comfortable from their very first visit." },
        style: { base: { size: { maxWidth: "70ch" }, appearance: { color: { token: "colors.muted" } } } },
      },
      ...
      "dental-appointment-sub": {
        ...
        type: "text",
        props: { content: "Tell us what you need and we'll confirm an available time by phone or email." },
        style: {
          base: {
      ...
      "dental-label-name": {
        ...
        type: "label",
        props: { text: "Full name", for: "dental-input-name" },
      ...
      "dental-label-email": {
        ...
        type: "label",
        props: { text: "Email", for: "dental-input-email" },
        style: defaultStyleFor("label"),
      },
      "dental-input-email": {
      ...
      "dental-label-treatment": {
        ...
        type: "label",
        props: { text: "Treatment of interest", for: "dental-select-treatment" },
        style: defaultStyleFor("label"),
      },
      ...
      "dental-label-message": {
        ...
        type: "label",
        props: { text: "Briefly tell us what you need", for: "dental-textarea-message" },
        style: defaultStyleFor("label"),
      },
      "dental-textarea-message": {
        id: "dental-textarea-message",
        type: "textarea",
        props: { name: "mensaje", placeholder: "E.g. I've had a toothache since yesterday…", rows: 4, required: false, disabled: false },
      ...
      "dental-footer-address": {
        ...
        type: "text",
        props: { content: "88 Real Street, Chapalita, Guadalajara, Jalisco" },
        style: { base: { appearance: { color: { token: "colors.surface.default" } } } },
      },
      "dental-footer-hours": {
        id: "dental-footer-hours",
        type: "text",
        props: { content: "Monday to Friday 9:00–19:00 · Saturdays 9:00–14:00" },
        style: { base: { appearance: { color: { token: "colors.surface.default" } } } },
      },
      ...
      "dental-footer-copyright": {
        ...
        type: "text",
        props: { content: "© 2026 Sonrisa Plena Dental Clinic. All rights reserved." },
        style: {
          base: {
            size: { width: "100%" },
  ...
  const translations: Record<string, NodeTranslations> = {
    "dental-topbar-phone": { es: { content: "Urgencias 24h: +52 33 1122 3344" }, it: { content: "Urgenze 24h: +52 33 1122 3344" } },
    "dental-navbar-brand": { es: { content: "<strong>Clínica Dental Sonrisa Plena</strong>" }, it: { content: "<strong>Clinica Dentale Sonrisa Plena</strong>" } },
    "dental-hero-badge": { es: { label: "Aceptamos seguros" }, it: { label: "Accettiamo assicurazioni" } },
    "dental-hero-title": { es: { content: "<strong>Cuidado dental cercano para toda la familia</strong>" }, it: { content: "<strong>Cure dentali vicino a te, per tutta la famiglia</strong>" } },
    "dental-hero-sub": { es: { content: "Consultorio moderno, equipo cálido y planes de tratamiento claros, con opciones para pagar con tu seguro dental." }, it: { content: "Uno studio moderno, un team accogliente e piani di trattamento chiari, con opzioni di pagamento tramite la tua assicurazione dentale." } },
    "dental-hero-cta": { es: { label: "Agendar mi cita" }, it: { label: "Prenota il mio appuntamento" } },
    "dental-treatments-title": { es: { content: "<strong>Nuestros tratamientos</strong>" }, it: { content: "<strong>I nostri trattamenti</strong>" } },
    "dental-treatment-1-icon": { es: { title: "Limpieza dental" }, it: { title: "Igiene dentale" } },
    "dental-treatment-1-media": { es: { alt: "Higienista dental realizando una limpieza" }, it: { alt: "Igienista dentale durante una pulizia" } },
    "dental-treatment-1-title": { es: { content: "<strong>Limpieza y prevención</strong>" }, it: { content: "<strong>Igiene e prevenzione</strong>" } },
    "dental-treatment-1-text": { es: { content: "Revisión y limpieza profesional para mantener tu salud bucal al día." }, it: { content: "Controlli e igiene professionale per mantenere la tua salute orale sempre in ordine." } },
    "dental-treatment-2-icon": { es: { title: "Ortodoncia" }, it: { title: "Ortodonzia" } },
    "dental-treatment-2-media": { es: { alt: "Alineadores dentales transparentes" }, it: { alt: "Allineatori dentali trasparenti" } },
    "dental-treatment-2-title": { es: { content: "<strong>Ortodoncia</strong>" }, it: { content: "<strong>Ortodonzia</strong>" } },
    "dental-treatment-2-text": { es: { content: "Brackets tradicionales y alineadores transparentes, con plan de pago a tu medida." }, it: { content: "Apparecchi tradizionali e allineatori trasparenti, con un piano di pagamento su misura." } },
    "dental-treatment-3-icon": { es: { title: "Odontopediatría" }, it: { title: "Odontoiatria pediatrica" } },
    "dental-treatment-3-media": { es: { alt: "Niña sonriendo en el consultorio dental" }, it: { alt: "Bambina che sorride nello studio dentistico" } },
    "dental-treatment-3-title": { es: { content: "<strong>Odontopediatría</strong>" }, it: { content: "<strong>Odontoiatria pediatrica</strong>" } },
    "dental-treatment-3-text": { es: { content: "Atención pensada para los más pequeños, en un ambiente relajado y amigable." }, it: { content: "Cure pensate per i più piccoli, in un ambiente rilassato e accogliente." } },
    "dental-alert": { es: { message: "¿Necesitas una cita de urgencia? Atendemos casos el mismo día sujeto a disponibilidad, llamando antes de venir." }, it: { message: "Hai bisogno di una visita urgente? Riceviamo casi lo stesso giorno in base alla disponibilità: chiama prima di venire." } },
    "dental-team-title": { es: { content: "<strong>Conoce a nuestro equipo</strong>" }, it: { content: "<strong>Conosci il nostro team</strong>" } },
    "dental-team-member-1-avatar": { es: { alt: "Retrato de la Dra. Camila Reyes" }, it: { alt: "Ritratto della Dott.ssa Camila Reyes" } },
    "dental-team-member-1-name": { es: { content: "<strong>Dra. Camila Reyes</strong>" }, it: { content: "<strong>Dott.ssa Camila Reyes</strong>" } },
    "dental-team-member-1-role": { es: { content: "Directora clínica y odontología general" }, it: { content: "Direttrice clinica e odontoiatria generale" } },
    "dental-team-member-2-avatar": { es: { alt: "Retrato del Dr. Andrés Molina" }, it: { alt: "Ritratto del Dott. Andrés Molina" } },
    "dental-team-member-2-name": { es: { content: "<strong>Dr. Andrés Molina</strong>" }, it: { content: "<strong>Dott. Andrés Molina</strong>" } },
    "dental-team-member-2-role": { es: { content: "Ortodoncia" }, it: { content: "Ortodonzia" } },
    "dental-team-member-3-avatar": { es: { alt: "Retrato de la Dra. Sofía Liévano" }, it: { alt: "Ritratto della Dott.ssa Sofía Liévano" } },
    "dental-team-member-3-name": { es: { content: "<strong>Dra. Sofía Liévano</strong>" }, it: { content: "<strong>Dott.ssa Sofía Liévano</strong>" } },
    "dental-team-member-3-role": { es: { content: "Odontopediatría" }, it: { content: "Odontoiatria pediatrica" } },
    "dental-testimonial": { es: { quote: "Le tenía mucho miedo al dentista, pero en Sonrisa Plena me explicaron cada paso y nunca me sentí presionada. Ahora vengo a mis revisiones sin ansiedad.", name: "Lorena Castillo", role: "Paciente desde 2023" }, it: { quote: "Avevo molta paura del dentista, ma da Sonrisa Plena mi hanno spiegato ogni passaggio e non mi sono mai sentita sotto pressione. Ora vengo ai controlli senza ansia.", name: "Lorena Castillo", role: "Paziente dal 2023" } },
    "dental-faq-title": { es: { content: "<strong>Preguntas frecuentes</strong>" }, it: { content: "<strong>Domande frequenti</strong>" } },
    "dental-faq-item-1": { es: { label: "¿Cuánto cuesta una primera valoración?" }, it: { label: "Quanto costa una prima valutazione?" } },
    "dental-faq-item-1-body": { es: { content: "La primera valoración tiene un costo de $450 MXN, e incluye revisión general y radiografía si es necesaria. El monto se descuenta si continúas con el tratamiento." }, it: { content: "La prima valutazione costa $450 MXN e comprende un controllo generale e una radiografia se necessaria. L'importo viene scontato se prosegui con il trattamento." } },
    "dental-faq-item-2": { es: { label: "¿Trabajan con aseguradoras?" }, it: { label: "Lavorate con le assicurazioni?" } },
    "dental-faq-item-2-body": { es: { content: "Sí, trabajamos con las principales aseguradoras del país. Trae tu póliza a la primera cita y verificamos tu cobertura sin costo." }, it: { content: "Sì, collaboriamo con le principali assicurazioni del paese. Porta la tua polizza alla prima visita e verificheremo la tua copertura senza costi." } },
    "dental-faq-item-3": { es: { label: "¿Qué debo esperar en mi primera visita?" }, it: { label: "Cosa devo aspettarmi alla prima visita?" } },
    "dental-faq-item-3-body": { es: { content: "Una revisión completa, una charla sobre tus necesidades y un plan de tratamiento claro con opciones y tiempos antes de decidir." }, it: { content: "Un controllo completo, una conversazione sulle tue esigenze e un piano di trattamento chiaro con opzioni e tempistiche prima di decidere." } },
    "dental-faq-item-4": { es: { label: "¿Atienden a niños?" }, it: { label: "Trattate anche i bambini?" } },
    "dental-faq-item-4-body": { es: { content: "Sí, contamos con un área de odontopediatría pensada para que los niños se sientan cómodos desde su primera cita." }, it: { content: "Sì, disponiamo di un'area di odontoiatria pediatrica pensata per far sentire i bambini a proprio agio dalla prima visita." } },
    "dental-appointment-title": { es: { content: "<strong>Agenda tu cita</strong>" }, it: { content: "<strong>Prenota il tuo appuntamento</strong>" } },
    "dental-appointment-sub": { es: { content: "Cuéntanos qué necesitas y te confirmamos horario disponible por teléfono o correo." }, it: { content: "Dicci di cosa hai bisogno e ti confermeremo un orario disponibile per telefono o email." } },
    "dental-label-name": { es: { text: "Nombre completo" }, it: { text: "Nome completo" } },
    "dental-input-name": { es: { placeholder: "Tu nombre completo" }, it: { placeholder: "Il tuo nome completo" } },
    "dental-label-email": { es: { text: "Correo electrónico" }, it: { text: "Email" } },
    "dental-input-email": { es: { placeholder: "tu@correo.com" }, it: { placeholder: "tu@email.com" } },
    "dental-label-treatment": { es: { text: "Tratamiento de interés" }, it: { text: "Trattamento di interesse" } },
    "dental-select-treatment": { es: { placeholder: "Elige una opción…", ariaLabel: "Tratamiento de interés", label: "Otro / no estoy seguro", value: "otro" }, it: { placeholder: "Scegli un'opzione…", ariaLabel: "Trattamento di interesse", label: "Altro / non sono sicuro", value: "otro" } },
    "dental-label-message": { es: { text: "Cuéntanos brevemente qué necesitas" }, it: { text: "Raccontaci brevemente di cosa hai bisogno" } },
    "dental-textarea-message": { es: { placeholder: "Ej. Me duele una muela desde ayer…" }, it: { placeholder: "Es. Ho mal di denti da ieri…" } },
    "dental-submit": { es: { label: "Solicitar cita" }, it: { label: "Richiedi appuntamento" } },
    "dental-footer-copyright": { es: { content: "© 2026 Clínica Dental Sonrisa Plena. Todos los derechos reservados." }, it: { content: "© 2026 Clinica Dentale Sonrisa Plena. Tutti i diritti riservati." } },
    "dental-footer-address": { es: { content: "Calle Real 88, Col. Chapalita, Guadalajara, Jalisco" }, it: { content: "Calle Real 88, Chapalita, Guadalajara, Jalisco" } },
    "dental-footer-hours": { es: { content: "Lunes a viernes 9:00–19:00 · Sábados 9:00–14:00" }, it: { content: "Lunedì-venerdì 9:00–19:00 · Sabato 9:00–14:00" } },
  };
