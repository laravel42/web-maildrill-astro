...
import { useBlockTypeSelected, useRoot, useSelectedScreenSize } from '../../../../../../documents/editor/EditorContext';
    ...
    case 'borderColor':
      return (
        <CompactableInput icon={BackgroundColorIcon} label={t('properties.border')}>
          <NullableColorInput label={t('properties.border')} defaultValue={defaultValue} onChange={handleChange} />
        </CompactableInput>
      );
    case 'borderRadius':
      return (
    ...
    case 'color':
      return (
        <CompactableInput icon={PaletteOutlined} label={t('properties.color')}>
          <NullableColorInput label={t('properties.color')} defaultValue={defaultValue} onChange={handleChange} />
        </CompactableInput>
      );
    case 'fontFamily':
      return (
        <CompactableInput icon={FontFamilyIcon} label={t('properties.fontFamily')}>
          <NullableFontFamily label={t('properties.fontFamily')} defaultValue={defaultValue} onChange={handleChange} />
        </CompactableInput>
      );
    case 'fontWeight':
      return (
        <CompactableInput icon={FormatBoldOutlined} label={t('properties.fontWeight')}>
          <FontWeightInput label={t('properties.fontWeight')} defaultValue={defaultValue} onChange={handleChange} />
        </CompactableInput>
      );
    case 'textAlign':
      return (
        selectedScreenSize === 'desktop' && (
          <CompactableInput icon={FormatAlignCenterOutlined} label={t('properties.alignment')}>
            <TextAlignInput label={t('properties.alignment')} defaultValue={defaultValue} onChange={handleChange} />
          </CompactableInput>
        )
      );
    case 'textAlignMobile':
        ...
        selectedScreenSize != 'desktop' && (
          <CompactableInput icon={PaddingIcon} label={t('properties.padding')}>
            <PaddingInput
              ...
              onSidesLinkedChange={(linked) => onChange({ ...value, mobilePaddingSidesLinked: linked })}
            />
          </CompactableInput>
        )
      );
      ...
      return (
        selectedScreenSize === 'desktop' && (
          <CompactableInput icon={HeightOutlined} label={t('properties.height')}>
            <HeightInput label={t('properties.height')} defaultValue={defaultValue} onChange={handleChange} />
          </CompactableInput>
        )
      );
    case 'heightMobile':
      ...
      return (
        selectedScreenSize != 'desktop' && (
          <CompactableInput icon={WidthFullOutlined} label={t('properties.width')}>
            <WidthInput
              label={t('properties.width')}
              defaultValue={resolveStyleValue<number>('widthMobile') ?? resolveStyleValue<number>('width') ?? undefined}
              onChange={handleChange}
            />
          </CompactableInput>
        )
        ...
        selectedScreenSize != 'desktop' && (
          <CompactableInput icon={BorderStyleOutlined} label={t('properties.border')}>
            <BorderInput
              ...
              borderBottom={resolveBorderValue('borderBottomMobile') ?? resolveBorderValue('borderBottom')}
              borderLeft={resolveBorderValue('borderLeftMobile') ?? resolveBorderValue('borderLeft')}
              borderRight={resolveBorderValue('borderRightMobile') ?? resolveBorderValue('borderRight')}
              onChange={handleBorderChange}
              sidesLinked={value.borderMobileSidesLinked}
              onSidesLinkedChange={(linked) => onChange({ ...value, borderMobileSidesLinked: linked })}
            />
          </CompactableInput>
        )
      );
