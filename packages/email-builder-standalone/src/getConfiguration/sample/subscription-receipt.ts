...
const SUBSCRIPTION_RECEIPT: TEditorConfiguration = {
  ...
  block_9mYZ55v7d29WRjNgPf5cuw: {
    ...
    data: {
      ...
      props: {
        html: '<p>Receipt from Remix Studios, Inc.</p>',
      },
    },
  },
  ...
  block_Y7W2h9xDuNreQdgMrv82KZ: {
    ...
    data: {
      ...
      props: {
        html: '<p>JULY 10, 2023 – AUGUST 1, 2023</p>',
      },
    },
  },
  ...
  block_Qq64GeHw7K24Fgz5oX81kt: {
    ...
    data: {
      ...
      props: {
        html: '<p>Can we help? Just reply to this email.</p>',
      },
    },
  },
};
