...
const WELCOME: TEditorConfiguration = {
  ...
  'block-1709571234315': {
    ...
    data: {
      ...
      props: {
        html: '<p>Welcome to Marketbase! Marketbase is how teams within fast growing marketplaces effortlessly monitor conversations to prevent disintermediation, identify problematic users, and increase trust &amp; safety within their community.</p>',
      },
    },
  },
  'block-1709571247550': {
    ...
    data: {
      ...
      props: {
        html: '<p>Best of all, you can connect your existing messaging services in minutes:</p>',
      },
    },
  },
  'block-1709571258507': {
  ...
  'block-1709571281151': {
    ...
    data: {
      ...
      props: {
        html: '<p>If you ever need help, just reply to this email and one of us will get back to you shortly. We’re here to help.</p>',
      },
    },
  },
  'block-1709571282795': {
