...
| Script                                                                                                                    | Purpose                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dev-all.mjs`                                                                                                             | `pnpm dev:all` — load root `.env`, start product (`PRODUCT_API_PORT`, default 3001), messaging (`API_PORT`, default 3002), email-builder (`EB_PORT`, default 3003), BullMQ workers; wait for those ports; then Astro with matching `*_API_BASE_URL`. Ctrl-C stops everything. Unified single-process: `pnpm dev:workers`. |
