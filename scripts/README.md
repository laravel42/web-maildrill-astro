...
| Script                                                                                                                    | Purpose                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| `dev-all.mjs`                                                                                                             | `pnpm dev:all` — start workers, wait for :3001, then start Astro; Ctrl-C stops both                                                         |
| `start-all.mjs`                                                                                                           | `pnpm start:all` — production twin of `dev-all.mjs`: unified workers `start` on :3001, then the built Astro server (`pnpm build` first). One supervisable process for Ploi-daemon testing; go-live uses Docker |
