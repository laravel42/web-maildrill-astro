...
const extra: RichSubscriber[] = [
  ...
  {
    id: 'sub_6',
    email: 'mei.t@studio.jp',
    name: 'Mei Tanaka',
    status: 'active',
    lists: ['Newsletter', 'Recent buyers'],
    tags: ['VIP'],
...
export const BUILTIN_SEGMENTS: SavedSegment[] = [
  ...
  },
  {
    ...
    name: 'Trial users',
    matchType: 'all',
    rows: [{ field: 'Tag', op: 'is', val: 'Trial' }],
  },
  {
    id: 'risk',
    name: 'At risk',
