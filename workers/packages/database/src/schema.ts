...
export const messageEvents = pgTable(
  ...
  (t) => [
    uniqueIndex("message_events_provider_fingerprint_uq").on(
      t.provider,
      t.eventFingerprint,
    ),
...
export const webhookEvents = pgTable(
  "webhook_events",
  {
    ...
    receivedAt: ts("received_at").defaultNow().notNull(),
    processedAt: ts("processed_at"),
    processingStatus: webhookStatusEnum("processing_status")
      .notNull()
      .default("pending"),
  ...
  (t) => [
    uniqueIndex("webhook_events_provider_fingerprint_uq").on(
      t.provider,
      t.eventFingerprint,
    ),
...
export const suppressions = pgTable(
  ...
  (t) => [
    uniqueIndex("suppressions_tenant_addr_channel_uq").on(
      t.tenantId,
      t.address,
      t.channel,
    ),
