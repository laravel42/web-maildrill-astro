...
export async function segmentRoutes(appRaw: FastifyInstance): Promise<void> {
  ...
  app.post("/v1/segments", { schema: { tags: TAG, summary: "Create a segment", body: createSchema } }, async (req, reply) =>
  ...
  app.get("/v1/segments/:id", { schema: { tags: TAG, summary: "Get a segment", params: idParam } }, async (req, reply) => {
  ...
  app.patch(
    "/v1/segments/:id",
    { schema: { tags: TAG, summary: "Update a segment", params: idParam, body: createSchema.partial() } },
    async (req, reply) => {
  ...
  app.delete("/v1/segments/:id", { schema: { tags: TAG, summary: "Delete a segment", params: idParam } }, async (req, reply) => {
  ...
  app.post(
    "/v1/segments/preview",
    { schema: { tags: TAG, summary: "Preview an ad-hoc rule set: matching subscribers + total count", body: previewSchema } },
    async (req) => {
  ...
  app.get(
    ...
    { schema: { tags: TAG, summary: "Evaluate a saved segment", params: idParam, querystring: evalQuery } },
    async (req, reply) => {
