...
export async function listRoutes(appRaw: FastifyInstance): Promise<void> {
  ...
  app.post("/v1/lists", { schema: { tags: TAG, summary: "Create a list", body: createSchema } }, async (req, reply) =>
  ...
  app.get("/v1/lists/:id", { schema: { tags: TAG, summary: "Get a list", params: idParam } }, async (req, reply) => {
  ...
  app.patch(
    "/v1/lists/:id",
    { schema: { tags: TAG, summary: "Update a list", params: idParam, body: createSchema.partial() } },
    async (req, reply) => {
  ...
  app.delete("/v1/lists/:id", { schema: { tags: TAG, summary: "Delete a list", params: idParam } }, async (req, reply) => {
  ...
  app.post(
    "/v1/lists/:id/members",
    { schema: { tags: TAG, summary: "Add a subscriber to a list", params: idParam, body: memberBody } },
    async (req, reply) => {
