...
export async function tagRoutes(appRaw: FastifyInstance): Promise<void> {
  ...
  app.post("/v1/tags", { schema: { tags: TAG, summary: "Create a tag", body: createSchema } }, async (req, reply) =>
  ...
  app.delete("/v1/tags/:id", { schema: { tags: TAG, summary: "Delete a tag", params: idParam } }, async (req, reply) => {
